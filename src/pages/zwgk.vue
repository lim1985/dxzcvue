...
<el-dialog :visible.sync="dialogVisible">
  <img width="100%" :src="dialogImageUrl" alt="">
        ...
        <div class="iconnav">
            <ul>
          <li><a href="http://wsbs.hunan.gov.cn/virtualhall/index.jsp?reLogin=1&areaCode=430503999000" class="hov"><i class="icon iconfont icon-webicon17"></i><span><p class="txt">我要办</p></span></a></li>
            ...
            <li><a href="http://www.dxzc.gov.cn/Government/ApplyFormQuery.aspx"><i class="icon iconfont icon-chaxun" style="font-size: 0.5rem; padding-top: 6%;"></i>
           <span><p class="txt">我要查</p></span></a></li>
        <li><a href="http://www.dxzc.gov.cn/Government/Letter/Letterwriter.aspx?DepartmentId=15"><i class="icon iconfont icon-pingjiaguanli" style="font-size: 0.5rem; padding-top: 6%;"></i><span>
...
<el-popover
  ...
  trigger="click">
  <!-- <el-tag
  v-for="(items,index) in Nodelist"
  closable
  :key="index"
  @close="shownodws(index)" 
  :type="'info'">
  {{items.nodename}}
  </el-tag> -->
  ...
  <!-- <el-table :data="Nodelist">
     <template>
    <el-table-column  @click="showalert()" width="100" property="nodename" label="姓名"></el-table-column>
     </template>
  </el-table> -->
</el-popover>
  	<div class="zfgk">
  	...
  	<div class="xxgk">
        ...
        <span>信息公开</span></a></div>
  		<ul class="xxr"><li><a target="_self" href="/#/depmorepage"><i class="icon iconfont icon-file"></i><span>公开指南</span></a></li>
  	  	...
  	  	<li style="margin-right: 0;"><a target="_blank" href="/Government/ApplyForm.aspx"><i class="icon iconfont icon-biaoshilei_yiduxinxi"></i><span>依申请公开</span></a></li></ul>
  	</div>
  	<!-- <ul id="tabcon" class="ico3">
      <li style="width: 40%;"><a target="_blank" href="/Category_1171/Index.aspx"><i class="icon iconfont icon-wenhuamingsheng"></i><span>重点办事服务</span></a></li>
  	  <li><a target="_blank" href="http://wsbs.hunan.gov.cn/virtualhall/index.jsp?reLogin=1&areaCode=430503999000"><i class="icon iconfont icon-09"></i><span>办事指南</span></a></li>
  	  <li style="margin-right: 0;"><a target="_blank" href="/Category_5/Index.aspx"><i class="icon iconfont icon-tongzhi"></i><span>通知公示</span></a></li>
    </ul> -->
...
<div class="xxcon">
        ...
        <div class="tabtwobox">
        	<ul id="tab_two_1" style="display: block;">
        	  ...
        	  <li><a href="http://www.dxzc.gov.cn/Category_129/Index.aspx" style="margin-right: 0;"><i class="icon iconfont icon-hrrenshirenshiguanli380"></i><span>实事项目</span></a></li>
        	  ...
        	  <li><a href="http://www.dxzc.gov.cn/Category_347/Index.aspx" style="margin-right: 0;"><i class="icon iconfont icon-wodehezuo"></i><span>应急管理</span></a></li>
        </ul>
...
<i @click="visibles = false" class="icon iconfont icon-guanbi"></i></div>
  ...
  <template v-for="(items,index) in topnodes">
   ...
   <li class="childnodelists">{{c.childNodes}}</li>
     ...
     <!-- <li :key="index" class="nodelists"><span>{{items.name}}</span></li> 

      <ul class="childs">
    <template v-for="(c) in items.items">     
     <li>{{c.childNodes}}</li>
  ...
  <div class="fgwj">
       ...
       <span @click="postnodes('通知公示')">通知公示</span>         
         <ul class="fgw">
        <li><a  id="three1" @click="setTabs('three',1,2)" class="hover">实事项目</a></li>
        <li><a  id="three2" @click="setTabs('three',2,2)">公开招考</a></li>
        </ul>
      </div>
  ...
  <div class="fgwj">
   ...
   <template v-for="(i,index) in zfwj">
  	...
  	<div class="ghjd">
    	...
    	<div v-show="false" class="ghjd">
  		<div class="title1"><span>规划计划及解读2</span></div>
  		<ul class="ghul">
...
//   import '.././assets/js/common.js'
  ...
  //  import myBanShiList from '.././components/banshilist.vue'
  	export default {    
		...
		data () {
			return {     
                    ...
                    node_index:[],
                    topnodes:[],
            /*通知公示节点集*/zfwjnodes:'252,257,279,829,833,837,841,845,849,853,858,862,866,870,874,878,882,886,890,894,898,902,906,910,914,926,930,938,1111,1022',
    ...
    //                 --------------------
    //                 	<li><a target="_self" href="http://www.dxzc.gov.cn/Category_1200/Index.aspx"><i class="icon iconfont icon-xiaofei01"></i><span>减税降费降低要素</span></a></li>
  	//   	<li style="margin-right: 0;"><a target="_self" href="http://www.dxzc.gov.cn/Category_1118/Index.aspx"><i class="icon iconfont icon-xiangzhenguanli"></i><span>重大建设项目</span></a></li>
  	//   	<li><a target="_self" href="http://www.dxzc.gov.cn/Category_1116/Index.aspx"><i class="icon iconfont icon-ziyuan"></i><span>公共资源配置</span></a></li>
  	//   	<li style="margin-right: 0;"><a target="_self" href="http://www.dxzc.gov.cn/Category_173/Index.aspx"><i class="icon iconfont icon-msnui-service"></i><span>“放管服”改革</span></a></li>
  	//   	<li><a target="_self" href="http://www.dxzc.gov.cn/Category_204/Index.aspx"><i class="icon iconfont icon-baohu"></i><span>防范遏制重特大生</span></a></li>
    //     <li style="margin-right: 0;"><a target="_self" href="http://www.dxzc.gov.cn/Category_1207/Index.aspx"><i class="icon iconfont icon-zhiliangbz"></i><span>产品质量提升</span></a></li>
    //    <li><a target="_self" href="http://www.dxzc.gov.cn/Category_1208/Index.aspx"><i class="icon iconfont icon-jingzhunfupin"></i><span>扶贫脱贫</span></a></li>
  	//   	<li style="margin-right: 0;"><a target="_self" href="http://www.dxzc.gov.cn/Category_818/Index.aspx"><i class="icon iconfont icon-huanjingbaohu"></i><span>环境保护</span></a></li>
    //    <li><a target="_self" href="http://www.dxzc.gov.cn/Category_817/Index.aspx"><i class="icon iconfont icon-shipin"></i><span>食品药品安全</span></a></li>
  	//   	<li style="margin-right: 0;"><a target="_self" href="http://www.dxzc.gov.cn/Category_154/Index.aspx"><i class="icon iconfont icon-jiaoyu"></i><span>教育卫生领域</span></a></li>
  	//   	<li><a target="_self" href="http://www.dxzc.gov.cn/Category_1208/Index_4.aspx"><i class="icon iconfont icon-wodehezuo"></i><span>社会救助</span></a></li>
  	//   	<li style="margin-right: 0;"><a target="_self" href="http://www.dxzc.gov.cn/Category_1204/Index.aspx"><i class="icon iconfont icon-servicejinkoubaoshui"></i><span>财税体制改革</span></a></li>
  	//   	<li><a target="_self" href="#"><i class="icon iconfont icon-zhongxinhuanjing"></i><span>促房地产市场发展</span></a></li>
  	//   	<li style="margin-right: 0;"><a target="_self" href="http://www.dxzc.gov.cn/Category_1207/Index.aspx"><i class="icon iconfont icon-jifenxinxi"></i><span>消费升级</span></a></li>
  	//   	<li><a target="_self" href="http://www.dxzc.gov.cn/Category_1206/Index.aspx"><i class="icon iconfont icon-xiaofeiquan"></i><span>化解过剩产能</span></a></li>
  	//   	<li style="margin-right: 0;"><a target="_self" href="http://www.dxzc.gov.cn/Category_170/Index.aspx"><i class="icon iconfont icon-qiangli"></i><span>加强预期引导</span></a></li>
    ...
    components: {
    // mydepments,newsDetail,mynodelist,myBanShiList
    },
     created(){
    ...
    methods: {
     ...
     this.Myunilt.Getcurnodename(nodename).then(v=>{
      ...
      getnodeslist:function(s,Nodes)
      {
        ...
        ///Category_1212/Index.aspx zhengshi jiekou
      ...
      Geterror:function(err, file, fileList)
          {
              console.log(err)
            
          },

   getGroup:function (arr, groupKey){
    var ret = [];
	  var keys = {};
	...
	return ret;
       ...
       calcStyle(key) {
          ...
          shownodws:function(i)
        {
           ...
           else
           {
            ...
            //  localStorage.removeItem('nodes_index',i);
           }            
        },
        HideandShowbanshilist:function()
        {
     ...
     { 
        for(var i=1;i<=n;i++)
         ...
         var html = datalist.replace(/^\s+|\s+$/g, '')
          .replace(/				/g,'')  
          .replace(/                        /g, "")                              
          .replace(/\r\n/g,'')
          .replace(/<br>/g, '')
     ...
     { 
        for(var i=1;i<=n;i++)
           ...
           getnodelists:function()
        {
         
          //     this.newsData=this.initdata
      //     this.showDetails = true
      //     let curitemid=this.curItem
          this.axios.get('', {//获取新闻列表的内容测试/Getnodelists//Category_1215/Index.aspx
            params: {
              NodeID: 110
            }
          }).then(res => {
            //     console.log(res.data.list)
                this.topnodes=res.data.data.Nodelists

                this.topnodes = this.getGroup(this.topnodes, 'ParentNodes');
